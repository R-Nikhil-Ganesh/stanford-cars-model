#!/usr/bin/env python3
"""
EfficientNet-B0 (35 Vehicle Makes): Diagnostic & Explainability Analysis Engine
=============================================================================
...
Can be imported in Jupyter notebooks or run directly from the command line:
    python output_analysis_35makes.py
"""
...
OUTPUT_DIR  = CURRENT_DIR / "output_efficientnet_b0_merged"
MODELS_DIR  = OUTPUT_DIR / "models"
REPORTS_DIR = OUTPUT_DIR / "reports"
PLOTS_DIR   = OUTPUT_DIR / "plots"
PRED_DIR    = OUTPUT_DIR / "predictions"
SPLITS_DIR  = Path("/home/researchadmin/Econ/external_datasets/merged_data")
...
def run_full_analysis():
    ...
    plot_f1_ranking(class_report, test_metrics, save_path=PLOTS_DIR / "f1_score_ranking_35makes.png")

    # 4. Confusion Matrix & Top Errors
    cm_norm, top_errors_df = plot_confusion_matrix_and_top_errors(
        y_true, y_pred, top_k=15, save_path=PLOTS_DIR / "confusion_matrix_35makes.png"
    )
